...
t_info g_infos[LEN_INFOS] = {
	{"|",
		"{green}#Definition :{eoc}\n\
			\'|\' is called  a \'pipe\'. it's a specific separator between two commands,\n\
		...
		{"alias",
			"{green}#Definition :{eoc}\n\
				...
				\n\
				{green}#How it works ?{eoc}\n\
			When you send a command to the shell, if it\'s present in the alias\'s list,\n\
				it\'s search recursively the {red}value{eoc} associated to the {green}key{eoc}.\n\
