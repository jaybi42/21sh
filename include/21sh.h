...
void	xmemdel(void **p);
//special function: free all the pointers you have previously malloced with xmalloc
...
void update_stack(t_executor ***p_stack, int *p_stack_index, t_exec *current_ex,
  t_av *current_av);
